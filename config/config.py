...
class Config:
    ...
    GITHUB_CLIENT_ID = '934950add9eae4dcef79'
    GITHUB_CLIENT_SECRET = 'b6d9603993aceaa1ec580c46d6a756aa918bbe89'
...
class DevelopmentConfig(Config):
    ...
    SQLALCHEMY_DATABASE_URI = 'mysql+pymysql://root:Wavlink@163@localhost/uwget'
